...
#ifndef EVGOP_LANCIADADO_HPP
#define EVGOP_LANCIADADO_HPP

#include "card.h"

class lanciaDado : public card {

public:
    lanciaDado(); // Costruttore
    void effect(game* g) override; // Lancia il dado
};


#endif //EVGOP_LANCIADADO_HPP
