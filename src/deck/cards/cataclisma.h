...
#ifndef EVGOP_CATACLISMA_H
#define EVGOP_CATACLISMA_H

#include "card.h"

class cataclisma : public card{

public:
    cataclisma();

    void effect(game* g) override; // Tutte le casella perdono n energia
};


#endif //EVGOP_CATACLISMA_H