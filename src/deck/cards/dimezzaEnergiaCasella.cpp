...
#include "dimezzaEnergiaCasella.h"
#include <iostream>

using namespace std;

dimezzaEnergiaCasella::dimezzaEnergiaCasella(){
    char name[LENGHT];
    strcpy(name, "Dimezza Energia Casella");
    setName(name);
};

void dimezzaEnergiaCasella::effect(game* g){
   g->dimezzaEnergiaCasella();
}