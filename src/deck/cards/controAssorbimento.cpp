...
#include "controAssorbimento.h"
#include <iostream>


using namespace std;

controAssorbimento::controAssorbimento() {
    char name[LENGHT];
    strcpy(name, "Contro Assorbimento");
    setName(name);
};

void controAssorbimento::effect(game* g){
    g->controAssorbimento();
}
