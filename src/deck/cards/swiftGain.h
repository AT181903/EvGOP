...
#ifndef EVGOP_SWIFTGAIN_H
#define EVGOP_SWIFTGAIN_H

#include "card.h"

class swiftGain : public card {
public:
    swiftGain();
    void effect(game* g) override; // Tutte le caselle guadagnano n energia

};


#endif //EVGOP_SWIFTGAIN_H
