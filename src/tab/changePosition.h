...
#ifndef EVGOP_CHANGEPOSITION_H
#define EVGOP_CHANGEPOSITION_H

#include "box.h"

class changePosition : public box {
public:
    changePosition(); // Costruttore
    void effect(game* g) override; // Cambia la posizione con quella di un giocatore a caso
};


#endif //EVGOP_CHANGEPOSITION_H
